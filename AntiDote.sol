...
interface IUniswapV2Router01 {
    ...
    function removeBuyBackWithPermit(
        address tokenA,
        address tokenB,
        uint liquidity,
        uint amountAMin,
    ...
    function removeBuyBackETHWithPermit(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeBuyBackETHSupportingFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
    ...
    function removeBuyBackETHWithPermitSupportingFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
...
contract AntiDote is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x680507bF0a0269A71E74359979dc22d90000649b); // Marketing Address
    address payable public charityAddress = payable(0xc5D86DdF9E13218Dcb17f63011d6f3C5226f410E); //charityAddress
    ...
    string private _name = "AntiDote";
    string private _symbol = "AntiDote";
    ...
    uint256 public _maxTxAmount = 30000000000000000000;
    uint256 private minimumTokensBeforeSwap = 1500000000000000; 
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //Send to Marketing & Charity address
        transferToAddressETH(marketingAddress, transferredBalance.div(_buyBackfee).mul(marketingDivisor));
        transferToAddressETH(charityAddress, transferredBalance.div(_buyBackfee).mul(charityDivisor));
    ...
    function setCharityAddress(address _charityAdd) external onlyOwner{
        charityAddress = payable(_charityAdd);
    }
